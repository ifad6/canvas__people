...
People.LeftPreLeg.moveTo([ [40, 0.5], [0, 0.5] ], true);
People.LeftLeg.moveTo([ [40, 0.5], [0, 0.5] ], true);
People.RightPreLeg.moveTo([ [40, 0.5], [0, 0.5] ], true);
People.RightLeg.moveTo([ [40, 0.5], [0, 0.5] ], true);
